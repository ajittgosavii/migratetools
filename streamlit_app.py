...
def calculate_complexity_analysis(servers, params):
    ...
    def get_complexity_level(score):
        if score < 25:
            return {'level': 'Low', 'color': '#38a169', 'description': 'Simple migration with minimal complexity'}
        elif score < 50:
            return {'level': 'Medium', 'color': '#d69e2e', 'description': 'Moderate complexity requiring careful planning'}
        elif score < 75:
            return {'level': 'High', 'color': '#e53e3e', 'description': 'Complex migration requiring expert resources'}
        else:
            return {'level': 'Very High', 'color': '#9f1239', 'description': 'Highly complex migration requiring extensive planning'}
    ...
    return {
        ...
        'complexity_level': get_complexity_level(total_score),  # Add this field
        'factors': factors,
